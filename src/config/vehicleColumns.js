...
export const VEHICLE_COLUMNS = [
  ...
  { id: "engineModel",          label: "原動機型式",       width: 110, type: "text",     field: "engineModel",    visible: false },
  { id: "vehicleWeight",        label: "車両重量(kg)",     width: 100, type: "number",   field: "vehicleWeight",  visible: false },
  { id: "grossVehicleWeight",   label: "車両総重量(kg)",   width: 110, type: "number",   field: "grossVehicleWeight", visible: false },
  { id: "engineDisplacement",   label: "排気量(cc)",       width: 95,  type: "number",   field: "engineDisplacement", visible: false },
  { id: "firstRegistrationDate",label: "初度登録",         width: 100, type: "text",     field: "firstRegistrationDate", visible: false },
