...
import { useAuth, Error, API } from "@/hooks/wrapper";
        ...
        <div className="p-8 bg-[var(--background)] min-h-screen">
            ...
            <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-[var(--success)]">{10}</p>
                </div>
            ...
            <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-[var(--warning)]">{10}</p>
                </div>
          ...
          <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg overflow-hidden shadow-lg">
            <div className="p-6 border-b border-[var(--border)]">
              <h2 className="text-xl font-semibold text-[var(--foreground)]">Companies ({1})</h2>
            </div>
                ...
                <tbody className="divide-y divide-[var(--border)]">
                  {companies.map((company) => (
                    <tr key={company.id} className="hover:bg-[var(--input)] transition-colors duration-200">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-[var(--secondary-foreground)]">{company.createdAt}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <button
                            className="p-2 text-[var(--secondary-foreground)] hover:text-[var(--foreground)] 
                                           hover:bg-[var(--input)] rounded-lg transition-all duration-200">
